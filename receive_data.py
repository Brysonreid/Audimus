...
class receive_data(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "receive_data", catch_exceptions=True)
        ...
        self.low_pass_filter_0_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_head_0 = blocks.head(gr.sizeof_gr_complex*1, 57600000)
...
def main(top_block_cls=receive_data, options=None):
    tb = top_block_cls()
