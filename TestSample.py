...
class TestSample(gr.top_block):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self._samp_rate_0_config = configparser.ConfigParser()
        self._samp_rate_0_config.read('LimeSDRConf.ini')
        try: samp_rate_0 = self._samp_rate_0_config.getfloat('Radio', 'Sample_Rate')
        except: samp_rate_0 = 768000
        ...
        self.blocks_head_0_0 = blocks.head(gr.sizeof_float*1, 14400000)
...
def main(top_block_cls=TestSample, options=None):
    tb = top_block_cls()
