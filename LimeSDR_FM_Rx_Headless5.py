...
class LimeSDR_FM_Rx_Headless5(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "LimeSDR_FM_Rx_Headless5", catch_exceptions=True)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, Storage_File, False)
...
def main(top_block_cls=LimeSDR_FM_Rx_Headless5, options=None):
    tb = top_block_cls()
