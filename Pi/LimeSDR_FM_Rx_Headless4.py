...
class LimeSDR_FM_Rx_Headless(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "LimeSDR_FM_Rx_Headless", catch_exceptions=True)
        ...
        except: Storage_File = 'C:\\Users\\bryso\\Downloads\\SDRdata'
        ...
        self.blocks_head_0_0 = blocks.head(gr.sizeof_float*1, 2880000)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'SDRdata', False)
...
def main(top_block_cls=LimeSDR_FM_Rx_Headless, options=None):
    tb = top_block_cls()
